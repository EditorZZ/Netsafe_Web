<script>
	...
	import { NetsafeAI, config, user, showSidebar, knowledge } from '$lib/stores';
			...
			<div class=" flex w-full space-x-2">
				...
				<div>
					<Tooltip content={$i18n.t('Create Group')}>
						<button
							class=" p-2 rounded-xl  dark:bg-gray-900 dark:hover:bg-gray-850 transition font-medium text-sm flex items-center space-x-1"
							on:click={() => {
